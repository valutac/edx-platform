$(document).ready(function() {
  ...
  // Store the inital contents so we can compare for unsaved changes
    ...
    // CodeMirror, that text area is hidden. We need to associate the label with CodeMirror (and there
    // is JS code in the wiki that depends on "id_content" to get the content).
